...
#SBATCH --job-name=physmon_stage6_d2r_qwen
#SBATCH --partition=gpu_a100_8
#SBATCH --gres=gpu:nvidia_a100-sxm4-80gb:1
#SBATCH --cpus-per-task=8
#SBATCH --mem-per-gpu=90G
#SBATCH --time=08:00:00
#SBATCH --output=/scratch/pabitra/physmon/slurm_logs/stage6_d2r_qwen_%j.out
#SBATCH --error=/scratch/pabitra/physmon/slurm_logs/stage6_d2r_qwen_%j.err
...
which python
python --version
echo "starting_run_behavioural_qwen_stage6_d2_rerun"
