#!/bin/bash
#SBATCH --job-name=physmon_stage5_probe_qwen
...
echo "=== PhysMon Stage 5 Probing Start ==="
...
python scripts/run_probing.py \
  ...
  --cross-model-activation-dir /scratch/pabitra/physmon/activations/llama_primary \
  --cross-model-role llama_primary \
  --seed 42

echo "=== PhysMon Stage 5 Probing Complete ==="
