#!/bin/bash
#SBATCH --job-name=physmon_stage5_probe_qwen_tier2
...
echo "=== PhysMon Stage 5 Tier 2 Probing Start ==="
...
cd "$PHYSMON_ROOT"
mkdir -p results/stage5/probing_tier2
...
python scripts/run_probing.py \
  ...
  --output-dir results/stage5/probing_tier2 \
  --seed 42

echo "=== PhysMon Stage 5 Tier 2 Probing Complete ==="
