...
#SBATCH --job-name=physmon_stage6_d2_llama
#SBATCH --partition=gpu_a100_8
#SBATCH --gres=gpu:nvidia_a100-sxm4-80gb:1
#SBATCH --cpus-per-task=8
#SBATCH --mem-per-gpu=90G
#SBATCH --time=10:00:00
#SBATCH --output=/scratch/pabitra/physmon/slurm_logs/stage6_d2_llama_%j.out
#SBATCH --error=/scratch/pabitra/physmon/slurm_logs/stage6_d2_llama_%j.err
...
which python
python --version
echo "starting_run_behavioural_llama_stage6_d2"
