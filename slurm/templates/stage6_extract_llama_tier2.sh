#!/bin/bash
# Stage 6 full-benchmark activation extraction on Llama (Tier 2: cue-token residuals).

#SBATCH --job-name=physmon_stage6_extract_llama_t2
...
echo "=== PhysMon Stage 6 Extraction Start (Llama Tier 2) ==="
...
echo "=== PhysMon Stage 6 Extraction Complete (Llama Tier 2) ==="
