#!/bin/bash
#SBATCH --job-name=physmon_s10_llm_attn_h200
#SBATCH --partition=gpu_h200_8
#SBATCH --gres=gpu:nvidia_h200_nvl:1
#SBATCH --time=04:00:00
#SBATCH --mem=80G
#SBATCH --cpus-per-task=8
#SBATCH --output=/scratch/pabitra/physmon/slurm_logs/%j_physmon_s10_llm_attn_h200.out
#SBATCH --error=/scratch/pabitra/physmon/slurm_logs/%j_physmon_s10_llm_attn_h200.err
...
for LAYER in 19 20 21; do
  python -u scripts/run_attention_analysis.py \
    --activation-dir /scratch/pabitra/physmon/activations_stage6/llama_primary \
    --layer "$LAYER" \
    --families "${FAMILIES[@]}" \
