...
#SBATCH --job-name=physmon_s10_llm_headsel
...
declare -A LAYER_HEADS
LAYER_HEADS[19]="0 12 14 26"
LAYER_HEADS[20]="23 2 20 18"
LAYER_HEADS[21]="7 8 5 19"

for LAYER in 19 20 21; do
  for HEAD in ${LAYER_HEADS[$LAYER]}; do
    OUTDIR="results/stage10/llama_head_selection_sweep/layer_${LAYER}/head_${HEAD}"
...
python scripts/analyse_llama_head_selection_sweep.py \
  --base-dir results/stage10/llama_head_selection_sweep \
  --output-path results/stage10/llama_head_selection_sweep/head_selection_summary.json
