...
#SBATCH --job-name=physmon_s9_cottext
#SBATCH --output=/scratch/pabitra/physmon/slurm_logs/s9_cottext_%j.out
...
python scripts/run_baselines_surface.py \
  ...
  --threshold 0.5 \
  --baseline-type cot_text_classifier \
  --exclude-ids CM_A_STD_018 CM_B_003 CM_B_UM_051 TH_B_UM_009 TH_B_UM_010 \
  --output-dir results/stage9/baselines/cot_text/ \
  --stage 9 --seed 42
