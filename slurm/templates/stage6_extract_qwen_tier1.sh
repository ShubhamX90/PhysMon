#!/bin/bash
# Stage 6 full-benchmark activation extraction on Qwen (Tier 1: last-prompt residuals).

#SBATCH --job-name=physmon_stage6_extract_qwen_t1
...
echo "=== PhysMon Stage 6 Extraction Start (Qwen Tier 1) ==="
...
echo "=== PhysMon Stage 6 Extraction Complete (Qwen Tier 1) ==="
