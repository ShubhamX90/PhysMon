#!/bin/bash
# Stage 9 probe ablation: variance probe with 2 variants (base + most-sensitive).

#SBATCH --job-name=physmon_s9_var_n2
...
python -u scripts/run_probing.py \
  ...
  --output-dir results/stage9/probe_ablation/n_variants_2/ \
  --stage 9 \
  --seed 42
