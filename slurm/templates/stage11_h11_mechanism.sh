...
#SBATCH --job-name=physmon_s11_h11_mech
...
python -u scripts/run_h11_output_analysis.py \
  ...
  --probe-layer 16 \
  --heads 11 14 15 24 \
  --output-dir results/stage11/science/h11_mechanism/ \
  --seed 42
...
python -u scripts/run_causal_patching.py \
  ...
  --head-index 24 \
  --behavioural-jsonl results/stage6/behavioural_full_rerun/qwen_primary_20260616T091228Z.jsonl \
  --output-dir results/stage11/science/h24_inhibitory/head24_layer_sweep/ \
  --stage 11 \
  --seed 42
