...
#SBATCH --job-name=physmon_s11_latent_geo
...
python -u scripts/analyse_latent_family_geometry.py \
  ...
  --deepseek-csv results/stage8/analysis_deepseek/deepseek_per_family.csv \
  --positive-families-file results/stage6/analysis_d2/stage6_positive_families.json \
  --output-dir results/stage11/science/latent_family_geometry/
