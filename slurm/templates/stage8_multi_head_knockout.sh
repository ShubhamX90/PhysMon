#!/bin/bash
# Stage 8 multi-head knockout over the identified layer-18 head set.

#SBATCH --job-name=physmon_stage8_mhk
...
echo "=== PhysMon Stage 8 Multi-Head Knockout Start ==="
...
echo "=== PhysMon Stage 8 Multi-Head Knockout Complete ==="
